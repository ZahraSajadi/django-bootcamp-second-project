...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        can_change_reservation = Permission.objects.get(codename="change_reservation")
        can_delete_reservation = Permission.objects.get(codename="delete_reservation")

        can_change_customuser = Permission.objects.get(codename="change_team")
        ...
        admins_group.permissions.add(can_change_reservation)
